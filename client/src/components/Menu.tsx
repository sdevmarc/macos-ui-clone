        ...
        <>
            <div className="fixed top-[2.5rem] right-[1rem] w-[17rem] p-[.7rem] rounded-xl backdrop-blur-[.4rem] bg-[#ffffff18] border-gray-400 border-[1px]">
                <div className="w-full h-[4rem] border-gray-400 border-[1px] rounded-xl bg-[#ffffff34] flex justify-evenly items-center">
                    <svg fill="#ffffff" width="20" height="20" viewBox="0 0 512 512" id="icons" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href='https://github.com/sdevmarc' target='_blank' className='text-white underline font-[400]'>
                        Made by sdevmarc.
                    </a>
                </div>
            </div>
